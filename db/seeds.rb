...
10.times do
  Event.create(user_id: User.all.sample.id, start_date: Date.today + rand(10..1000), duration: rand(60..242), title: Faker::Superhero.descriptor, price: rand(1..1000), location: Faker::Movies::HarryPotter.location, description: Faker::GreekPhilosophers.quote)
end
puts "Events Created!"
